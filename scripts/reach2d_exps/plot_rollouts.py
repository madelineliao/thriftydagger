...
def parse_args():
    ...
    parser.add_argument('--date', type=str, default='jan2')
...
def main(args):
    ...
    for N in NS:
        exp_name = f'{args.date}/{args.environment}/{args.method}/{exp_name_arch}/eval/{args.data_source}_N{N}_seed{args.seed}' 
