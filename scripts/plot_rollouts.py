...
def parse_args():
    ...
    parser.add_argument('--data_source', type=str, default='fixed_oracle_over')
    parser.add_argument('--date', type=str, default='jan3_hidden400')
    ...
    parser.add_argument('--train_seed', type=int, default=4)
